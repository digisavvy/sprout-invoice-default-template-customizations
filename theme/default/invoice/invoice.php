				...
				<div class="row intro">
					...
					<div class="row title">
						<?php if ( 'write-off' === si_get_invoice_status() ) : ?>
							<h2 class="invoice-void"><?php esc_html_e( 'Void', 'sprout-invoices' ) ?></h2>
						<?php elseif ( ! si_get_invoice_balance() ) : ?>
							<h2 class="invoice-paid"><?php esc_html_e( 'Paid', 'sprout-invoices' ) ?></h2>
						<?php elseif ( 'temp' === si_get_invoice_status() ) : ?>
							<h2 class="invoice-temp"><?php esc_html_e( 'Not Yet Published', 'sprout-invoices' ) ?></h2>
						<?php else : ?>
							<h2 class="invoice-pending"><?php esc_html_e( 'Payment Pending', 'sprout-invoices' ) ?></h2>
						<?php endif; ?>
